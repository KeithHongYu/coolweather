...
public class WeatherActivity extends AppCompatActivity {
    ...
    private void loadBingPic() {
        ...
        HttpUtil.setOkHttpRequset(requestBingPic, new Callback() {
            @Override
    ...
    public void requestWeather(final String weatherId) {
        String weatherUrl = "http://guolin.tech/api/weather?cityid=" + weatherId + "&key=e7093ae053e8486b86de23905d2636a1";
        HttpUtil.setOkHttpRequset(weatherUrl, new Callback() {
            @Override
            public void onFailure(Call call, IOException e) {
                runOnUiThread(new Runnable() {
                    @Override
